function [rotmat,cornerpoints,h,surface,edgelength] = boundbox(x,y,z,metric,level)
...
%      ];
 h = [minmax(1,1),minmax(1,2),minmax(1,3);    % xmin,ymin,zmin  1
     minmax(2,1),minmax(1,2),minmax(1,3);    % xmax,ymin,zmin  2
     minmax(2,1),minmax(1,2),minmax(2,3);    % xmax,ymin,zmax  3
     minmax(1,1),minmax(1,2),minmax(2,3);    % xmin,ymin,zmax  4
     minmax(1,1),minmax(2,2),minmax(1,3);    % xmin,ymax,zmin  5
     minmax(2,1),minmax(2,2),minmax(1,3);    % xmax,ymax,zmin  6     
     minmax(2,1),minmax(2,2),minmax(2,3);    % xmax,ymax,zmax  7
     minmax(1,1),minmax(2,2),minmax(2,3);    % xmin,ymax,zmax  8
     ];
